...
* Clarify reason for removing Nouveau modules [Alan Boris]
* Add repo.yml with generic type definition [Alan Boris]
* Update examples and remove balenalib base images [Alan Boris]
